    ...
    class Runner
      ...
      def parser
        @parser ||= OptionParser.new do |opts|
          ...
          EOS
          opts.on("--redis-client-certificate-path FILE_PATH", help) do |path|
          ...
          help = <<~EOS
            ...
            Required if running Redis with client certificate authentication.
          EOS
          opts.on("--redis-client-certificate-key-path FILE_PATH", help) do |path|
          ...
          EOS
          opts.on("--redis-disable-certificate-verification", help) do
